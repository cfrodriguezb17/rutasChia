                ...
                <div class="md:grid md:grid-cols-3 md:gap-6">
                    <div class="md:col-span-1 mb-3">
                        <div class="px-4 sm:px0">
                            <h3 class="text-lg text-gray-900">Añadir ruta</h3>
                            <p class="text-sm text-gray-600">Ingresa la información de la ruta que quiere añadir</p>
                            <div class="mt-3">
...
<script>
    ...
    export default defineComponent({
        ...
        methods: {
            submit(){
                this.$inertia.post(this.route('rides.store'), this.form)
            },
        },
    })
</script>